...
main()
{
        ...
        ambientPlay( "ambient_dcburning_building1" );
        precacheItem("m40a3");
        precacheModel("prop_flag_ranger");
        precacheModel("prop_flag_speznas");

        create_whitehouse_flags( (-21046.7, 7536, -201.875), (-20470.1, 6845.65, -1.875), (-20428.7, 7114.46, -0.875001), (-21163.9, 7488.32, -201.875) );
...
create_whitehouse_flags(enter, exit, enter2, exit2)
{
    whitehouse_flag[1] = spawn( "script_model", enter );
    whitehouse_flag[1] setModel( "prop_flag_ranger" );

    whitehouse_flag[2] = spawn( "script_model", exit );
    whitehouse_flag[2] setModel( "prop_flag_ranger" );

    whitehouse_flag[3] = spawn( "script_model", exit2 );
    whitehouse_flag[3] setModel( "prop_flag_speznas" );

    whitehouse_flag[4] = spawn( "script_model", enter2 );
    whitehouse_flag[4] setModel( "prop_flag_speznas" );
}